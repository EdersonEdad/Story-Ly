...
public class MayAlagaAkongBakulaw
{
	
	public JFrame frame;
	
	
	ImageIcon P1 = new ImageIcon(getClass().getResource("B1.png"));
	ImageIcon P2 = new ImageIcon(getClass().getResource("B2.png"));
	ImageIcon P3 = new ImageIcon(getClass().getResource("B3.png"));
	ImageIcon P4 = new ImageIcon(getClass().getResource("B4.png"));
	ImageIcon P5 = new ImageIcon(getClass().getResource("B5.png"));
	ImageIcon P6 = new ImageIcon(getClass().getResource("B6.png"));
	ImageIcon P7 = new ImageIcon(getClass().getResource("B7.png"));
	ImageIcon P8 = new ImageIcon(getClass().getResource("B8.png"));
	ImageIcon P9 = new ImageIcon(getClass().getResource("B9.png"));
	ImageIcon P10 = new ImageIcon(getClass().getResource("B10.png"));
	ImageIcon P11 = new ImageIcon(getClass().getResource("B11.png"));
	ImageIcon P12 = new ImageIcon(getClass().getResource("B12.png"));
	ImageIcon P13 = new ImageIcon(getClass().getResource("B13.png"));
	ImageIcon P14 = new ImageIcon(getClass().getResource("B14.png"));
	
	
	

	ImageIcon[] imagearr = {P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14};
	...
	//This Part is where the Frame of the software were customized
		...
		ImageIcon Label1 = new ImageIcon(getClass(). getResource("Story2.png"));
		...
		ImageIcon Label2 = new ImageIcon(getClass(). getResource("Story2_title_img.png"));
		...
		JLabel lblNewLabel_5 = new JLabel("MAY ALAGA AKONG BAKULAW");
		...
		JLabel lblNewLabel_6 = new JLabel("Kwento ni Becky Bravo");
