...
public class QuizforStory4 implements ActionListener{
	
	public JFrame frame;

	String[] questions = 	{
			"Sino ang ngamamalaki ng kanyang bilis"
			+ "\nsa pagtakbo?",
			"Sino ang iniinsulto ni kuneho sa"
			+ "\npagiging mabagal nito?",
			"Sino ang naghahamon ng isang karera"
			+ "\npabilisang tumakbo?",
			"Sino ang nakatulog sa karera ng"
			+ "\npabilisan?",
			"Sino ang nanalo sa karera ng "
			+ "\npabilisan tumakbo?"
		};
	String[][] options = 	{
			{"LEON", "TIGRE", "PAGONG", "KUNEHO"},
			{"PAGONG", "SLOTH", "BAKA", "TIGRE"},
			{"BAKA", "BABOY", "KUNEHO", "PAGONG"},
			{"TIGRE", "IBON", "KUNEHO", "PAGONG"},
			{"LEON", "PAGONG", "KUNEHO", "IBON"}
		};
	char[] answers ={
			'D',
			'A',
