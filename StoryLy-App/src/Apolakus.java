...
public class Apolakus
{
	
	public JFrame frame;
	
	
	ImageIcon P1 = new ImageIcon(getClass().getResource("C1.png"));
	ImageIcon P2 = new ImageIcon(getClass().getResource("C2.png"));
	ImageIcon P3 = new ImageIcon(getClass().getResource("C3.png"));
	ImageIcon P4 = new ImageIcon(getClass().getResource("C4.png"));
	ImageIcon P5 = new ImageIcon(getClass().getResource("C5.png"));
	ImageIcon P6 = new ImageIcon(getClass().getResource("C6.png"));
	ImageIcon P7 = new ImageIcon(getClass().getResource("C7.png"));
	ImageIcon P8 = new ImageIcon(getClass().getResource("C8.png"));
	ImageIcon P9 = new ImageIcon(getClass().getResource("C9.png"));
	ImageIcon P10 = new ImageIcon(getClass().getResource("C10.png"));
	ImageIcon P11 = new ImageIcon(getClass().getResource("C11.png"));
	ImageIcon P12 = new ImageIcon(getClass().getResource("C12.png"));
	ImageIcon P13 = new ImageIcon(getClass().getResource("C13.png"));
	ImageIcon P14 = new ImageIcon(getClass().getResource("C14.png"));
	...
	//This Part is where the Frame of the software were customized
		...
		ImageIcon Label1 = new ImageIcon(getClass(). getResource("Story3.png"));
		...
		ImageIcon Label2 = new ImageIcon(getClass(). getResource("Story3_title_img.png"));
		...
		JLabel lblNewLabel_5 = new JLabel("APOLAKUS");
		...
		JLabel lblNewLabel_6 = new JLabel("Kwento ni Alice Mallari");
