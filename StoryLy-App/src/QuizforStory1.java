...
public class QuizforStory1 implements ActionListener{
	
	public JFrame frame;

	String[] questions = 	{
			"Sino ang Pangunahing Tauhan sa Kwento?",
			"Sino ang gustong kumain kay Juan?",
			"Sino ang nagdadala ng bigas sa palengke "
			+ "\npara sa kanyang panginoon?",
			"Sino ang sinusuot ng kanyang panginoon "
			+ "\nat pinagmamalaki sa sa lungsod?",
			"Sino ang tumulong kay Juan para "
			+ "\nmakaligtas sa buwaya?"
		};
	String[][] options = 	{
			{"JUAN", "BUWAYA", "BASKET", "UNGGOY"},
			{"JUAN", "BASKET","BUWAYA","SOMBRERO"},
			{"UNGGOY","BASKET","BUWAYA","JUAN"},
			{"SOMBRERO","UNGGOY","JUAN","BASKET"},
			{"AMA","JUAN","BUWAYA","UNGGOY"}
		};
	char[] answers = 		{
			'A',
			'C',
