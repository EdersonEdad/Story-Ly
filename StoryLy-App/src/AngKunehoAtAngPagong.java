...
public class AngKunehoAtAngPagong
{
	
public JFrame frame;
	
	
	ImageIcon P1 = new ImageIcon(getClass().getResource("D1.jpg"));
	ImageIcon P2 = new ImageIcon(getClass().getResource("D2.jpg"));
	ImageIcon P3 = new ImageIcon(getClass().getResource("D3.jpg"));
	ImageIcon P4 = new ImageIcon(getClass().getResource("D4.jpg"));
	ImageIcon P5 = new ImageIcon(getClass().getResource("D5.jpg"));
	ImageIcon P6 = new ImageIcon(getClass().getResource("D6.jpg"));
	ImageIcon P7 = new ImageIcon(getClass().getResource("D7.jpg"));
	ImageIcon P8 = new ImageIcon(getClass().getResource("D8.jpg"));
	ImageIcon P9 = new ImageIcon(getClass().getResource("D9.jpg"));
	ImageIcon P10 = new ImageIcon(getClass().getResource("D10.jpg"));
	ImageIcon P11 = new ImageIcon(getClass().getResource("D11.jpg"));
	ImageIcon P12 = new ImageIcon(getClass().getResource("D12.jpg"));
	ImageIcon P13 = new ImageIcon(getClass().getResource("D13.jpg"));
	...
	//This Part is where the Frame of the software were customized
		...
		ImageIcon Label1 = new ImageIcon(getClass(). getResource("Story4.png"));
		...
		ImageIcon Label2 = new ImageIcon(getClass(). getResource("Story4_title_img.png"));
		...
		JLabel lblNewLabel_5 = new JLabel("ANG KUNEHO AT PAGONG");
		...
		JLabel lblNewLabel_6 = new JLabel("Kwento ni Aesop");
