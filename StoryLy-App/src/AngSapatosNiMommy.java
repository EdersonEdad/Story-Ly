...
public class AngSapatosNiMommy
{
	
	public JFrame frame;
	
	ImageIcon P1 = new ImageIcon(getClass().getResource("E1.png"));
	ImageIcon P2 = new ImageIcon(getClass().getResource("E2.png"));
	ImageIcon P3 = new ImageIcon(getClass().getResource("E3.png"));
	ImageIcon P4 = new ImageIcon(getClass().getResource("E4.png"));
	ImageIcon P5 = new ImageIcon(getClass().getResource("E5.png"));
	ImageIcon P6 = new ImageIcon(getClass().getResource("E6.png"));
	ImageIcon P7 = new ImageIcon(getClass().getResource("E7.png"));
	ImageIcon P8 = new ImageIcon(getClass().getResource("E8.png"));
	ImageIcon P9 = new ImageIcon(getClass().getResource("E9.png"));
	ImageIcon P10 = new ImageIcon(getClass().getResource("E10.png"));
	ImageIcon P11 = new ImageIcon(getClass().getResource("E11.png"));
	ImageIcon P12 = new ImageIcon(getClass().getResource("E12.png"));
	ImageIcon P13 = new ImageIcon(getClass().getResource("E13.png"));
	ImageIcon P14 = new ImageIcon(getClass().getResource("E14.png"));
...
int index = 0;
	...
	//This Part is where the Frame of the software were customized
		...
		ImageIcon Label1 = new ImageIcon(getClass(). getResource("Story5.png"));
		...
		ImageIcon Label2 = new ImageIcon(getClass(). getResource("Story5_title_img.png"));
		...
		JLabel lblNewLabel_5 = new JLabel("ANG SAPATOS NI MOMMY");
		...
		JLabel lblNewLabel_6 = new JLabel("Kwento ni Segundo Matias, Jr.");
