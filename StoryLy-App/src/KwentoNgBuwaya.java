...
public class KwentoNgBuwaya
{
	
	public JFrame frame;
	
	
	ImageIcon P1 = new ImageIcon(getClass().getResource("A1.jpg"));
	ImageIcon P2 = new ImageIcon(getClass().getResource("A2.jpg"));
	ImageIcon P3 = new ImageIcon(getClass().getResource("A3.jpg"));
	ImageIcon P4 = new ImageIcon(getClass().getResource("A4.jpg"));
	ImageIcon P5 = new ImageIcon(getClass().getResource("A5.jpg"));
	ImageIcon P6 = new ImageIcon(getClass().getResource("A6.jpg"));
	ImageIcon P7 = new ImageIcon(getClass().getResource("A7.jpg"));
	ImageIcon P8 = new ImageIcon(getClass().getResource("A8.jpg"));
	ImageIcon P9 = new ImageIcon(getClass().getResource("A9.jpg"));
	ImageIcon P10 = new ImageIcon(getClass().getResource("A10.jpg"));
	ImageIcon P11 = new ImageIcon(getClass().getResource("A11.jpg"));
	ImageIcon P12 = new ImageIcon(getClass().getResource("A12.jpg"));
	ImageIcon P13 = new ImageIcon(getClass().getResource("A13.jpg"));
	ImageIcon P14 = new ImageIcon(getClass().getResource("A14.jpg"));
	ImageIcon P15 = new ImageIcon(getClass().getResource("A15.png"));
	ImageIcon P16 = new ImageIcon(getClass().getResource("A16.png"));
	ImageIcon P17 = new ImageIcon(getClass().getResource("A17.jpg"));
	ImageIcon P18 = new ImageIcon(getClass().getResource("A18.jpg"));
	ImageIcon P19 = new ImageIcon(getClass().getResource("A19.jpg"));
	
	

	ImageIcon[] imagearr = {P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19};
	...
	//This Part is where the Frame of the software were customized
		...
		ImageIcon Label1 = new ImageIcon(getClass(). getResource("Story1.png"));
		...
		ImageIcon Label2 = new ImageIcon(getClass(). getResource("Story1_title_img.png"));
		...
		JLabel lblNewLabel_5 = new JLabel("KWENTO NG BUWAYA");
		...
		JLabel lblNewLabel_6 = new JLabel("nina Jose at Ariana Juego");
