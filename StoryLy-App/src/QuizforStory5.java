...
public class QuizforStory5 implements ActionListener{
	
	public JFrame frame;

	String[] questions = 	{
			"Sino ang nagpabili ng spider-man"
			+ "\nna damit sa kanyang Nanay?",
			"Ano ang laging sinusukat ng Mommy"
			+ "\nng magkapatid?",
			"Ano ang pinabili ni Luigi sa "
			+ "\nkanyan kaarawan?",
			"Saan kumain ang pamilya pagkatapos"
			+ "\nmaglaro ng magkapatid?",
			"Ano ang supresa ng magkaptid sa"
			+"\nkaarawan ng kanilang Mommy?"
		};
	String[][] options = 	{
			{"MARIO", "TITA LETTY", "LUIGI", "ATE CHIE"},
			{"T-SHIRT", "DAMIT", "BLOUSE", "SAPATOS"},
			{"CELLPHONE", "XBOX", "PSP", "PS5"},
			{"CHOWKING", "JOLIBEE", "SA BAHAY", "MCDO"},
			{"SAPATOS", "DAMIT", "TSINELAS", "SOMBRERO"}
		};
	char[] answers ={
			'C',
			'D',
