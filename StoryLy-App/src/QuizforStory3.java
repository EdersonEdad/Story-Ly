...
public class QuizforStory3 implements ActionListener{
	
	public JFrame frame;

	String[] questions = 	{
			"Sino ang pangunahing tauhan sa kwento?",
			"Sino ang Nanay ni Dadoy?",
			"Sino ang pumitik sa nanlalamig na"
			+ "\ntenga ni Dadoy?",
			"Sino ang kumain ng kanyang baunan sa"
			+ "\nkanyang palusot sa nanay nito?",
			"Sino ang nagpaligo ng pulbos sa mukha "
			+ "\nng magikero na si Dadoy?"
		};
	String[][] options = 	{
			{"YUKI", "DADOY", "AMANDA", "JAY-JAY"},
			{"MARIA", "MARITES", "AMANDA", "ANG PUSA"},
			{"YUKI", "JAY-JAY", "ANG GURO", "AMANDA"},
			{"ANG GURO", "JAY-JAY", "YUKI", "UNGGOY"},
			{"ANG GURO", "EDWARD", "JAY-JAY", "YUKI"}
		};
	char[] answers = 		{
			'B',
			'C',
