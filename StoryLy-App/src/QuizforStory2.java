...
public class QuizforStory2 implements ActionListener{
	
	public JFrame frame;

	String[] questions = 	{
			"Anong pangalan ng bakulaw sa kwento?",
			"Sino ang kaibigan n bakulaw?",
			"Ilang linggong pinaghahanda ng nanay"
			+ "\nng pagkain ang bakulaw?",
			"Sino ang asawa ng bakulaw?",
			"Sino ang kausap ng nanay sa pinto "
			+ "\nnang tumunog ang timbre sa labas.?"
		};
	String[][] options = 	{
			{"SI LIIT", "EDWARD", "ROBERT", "JOHN"},
			{"ANG NANAY", "SI LIIT", "ASO", "SI LAKI"},
			{"DALAWA", "TATLO", "APAT", "ISA"},
			{"CELINA", "ANG NANAY", "MARIA", "SI LIIT"},
			{"SI LIIT", "ROBERT", "EDAWRD", "JOSEPH"}
		};
	char[] answers = 		{
			'C',
			'B',
